...
api.add_resource(resources.Subscriptions, '/subscription/<user_id>')
api.add_resource(resources.Comment, '/comment')
api.add_resource(resources.Rating, '/rating')
api.add_resource(resources.ForumPost, '/forumPost/<post_id>')
api.add_resource(resources.ForumPosts, '/forumPosts')
api.add_resource(resources.Build, '/build/<build_id>')
